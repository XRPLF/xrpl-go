...
- Added `ValidateSponsorFields` and `InspectSponsorFields` for non-mutating raw sponsorship validation without requiring autofilled fields. Inspection returns the validated typed sponsor signature while preserving field presence.
