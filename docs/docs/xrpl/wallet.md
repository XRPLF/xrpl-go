...
See the runnable sponsor examples for [RPC](https://github.com/XRPLF/xrpl-go/tree/main/examples/sponsor-signing/rpc) and [WebSocket](https://github.com/XRPLF/xrpl-go/tree/main/examples/sponsor-signing/ws) for complete co-signed, multisigned, and pre-funded flows on devnet.
