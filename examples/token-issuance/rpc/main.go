...
func configureHotWallet(client *rpc.Client, hotWallet wallet.Wallet) error {
...
func createHotTrustLine(client *rpc.Client, coldWallet, hotWallet wallet.Wallet) error {
...
func createCustomerTrustLine(client *rpc.Client, coldWallet, customerOneWallet wallet.Wallet) error {
...
func issueToHotWallet(client *rpc.Client, coldWallet, hotWallet wallet.Wallet) error {
...
func issueToCustomer(client *rpc.Client, coldWallet, customerOneWallet wallet.Wallet) error {
...
func freezeColdWallet(client *rpc.Client, coldWallet wallet.Wallet) error {
...
func tryFrozenPayment(client *rpc.Client, coldWallet, hotWallet, customerOneWallet wallet.Wallet) error {
...
func unfreezeColdWallet(client *rpc.Client, coldWallet wallet.Wallet) error {
...
func sendAfterUnfreeze(client *rpc.Client, coldWallet, hotWallet, customerOneWallet wallet.Wallet) error {
	fmt.Println("⏳ Trying to send tokens from hot wallet to customer one...")
	hotToCustomerOnePayment := &transactions.Payment{
		BaseTx: transactions.BaseTx{
			Account: types.Address(hotWallet.ClassicAddress),
...
func submitAndWait(client *rpc.Client, tx transactions.FlatTransaction, signer wallet.Wallet, expected transactions.TxResult) error {
