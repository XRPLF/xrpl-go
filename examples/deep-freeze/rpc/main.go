...
func configureTrustLines(client *rpc.Client, issuer, holderWallet1, holderWallet2 wallet.Wallet) error {
...
func mintAndTransferTokens(client *rpc.Client, issuer, holderWallet1, holderWallet2 wallet.Wallet) error {
	// Minting to Holder 1
...
func freezeAndTryTransfers(client *rpc.Client, issuer, holderWallet1, holderWallet2 wallet.Wallet) error {
...
func unfreezeAndTransferTokens(client *rpc.Client, issuer, holderWallet1, holderWallet2 wallet.Wallet) error {
