...
func sendCosignedPayment(client *rpc.Client, account, sponsor wallet.Wallet, payment transaction.Payment) error {
...
func sendMultisignedPayment(client *rpc.Client, account, sponsor wallet.Wallet, payment transaction.Payment) error {
...
func sendPrefundedPayment(client *rpc.Client, account, sponsor wallet.Wallet, payment transaction.Payment) error {
...
func submitSetup(client *rpc.Client, signer wallet.Wallet, flatTx transaction.FlatTransaction, label string) error {
	if err := client.Autofill(&flatTx); err != nil {
		return err
	}
...
func submitBlob(client *rpc.Client, txBlob, label string) error {
