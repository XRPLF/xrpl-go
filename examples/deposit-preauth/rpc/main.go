...
func configureCredentialAuthorization(client *rpc.Client, issuer, holderWallet1 wallet.Wallet, credentialType types.CredentialType) error {
...
func getCredentialID(client *rpc.Client, holderWallet1 wallet.Wallet) (string, error) {
...
func sendPaymentsAndRevokeAuthorization(client *rpc.Client, issuer, holderWallet1 wallet.Wallet, credentialType types.CredentialType, credentialID string) error {
...
func submitAndWait(client *rpc.Client, tx transaction.FlatTransaction, signer wallet.Wallet, expected transaction.TxResult) error {
