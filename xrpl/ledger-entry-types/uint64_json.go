...
// and unsigned JSON integers accepted by the xrpl.js UInt64 codec. maxDigits
// mirrors the xrpl.js length caps, rejecting overlong leading-zero strings that
// would otherwise fit in 64 bits.
