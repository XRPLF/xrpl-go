...
// ConfidentialMPTFeeMultiplier is the base fee multiplier for confidential MPT transactions.
const ConfidentialMPTFeeMultiplier uint64 = 10

func (t TxType) String() string {
	return string(t)
}

// IsConfidentialMPTTransactionType reports whether txType is a confidential MPT transaction.
func IsConfidentialMPTTransactionType(txType TxType) bool {
	switch txType { //nolint:exhaustive // Only confidential MPT transaction types need cases.
	case ConfidentialMPTClawbackTx,
